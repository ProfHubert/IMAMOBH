...
% 
%             end            
            Point7(i) = Point7(i) + (length(e) + 1)*allppi(a3,1);      
...
% 
%             end            
            Point9(i) = Point9(i) + (length(e) + 1)*allppi(a3,2);
...
bh_option = struct('maxgen',300,'sizestar',100,'els_max',0.3,'els_min',0.1);
